...
- `bus/` — central router (to be built)
- `calendar-agent/` — Ambiguous Assistant integration
...
- `docs/architecture.txt` — the three services and how they connect
- `docs/INTERFACES.md` — component ownership and contracts
- `docs/messaging.md` — running the messaging service
- `docs/frontend.md` — the call-your-agent web app
- `docs/setup.md` — workspace provisioning and test hooks
