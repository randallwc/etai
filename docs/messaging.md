...
.env:
    ...
    CARRIER_GATEWAYS='{"+15550100100":"vtext.com","+15550100101":"txt.att.net"}'
...
+15550100100 is Verizon (vtext.com; replies arrive from vzwpix.com) and
+15550100101 is AT&T (txt.att.net). Add a line per known recipient; for
...
from the number's gateway address (e.g. 5550100100@vzwpix.com). The
...
Env vars (all default to the repo .env values):
  ...
  CLIENT_PHONE           simulated sender, E.164 (default +15550100100)
